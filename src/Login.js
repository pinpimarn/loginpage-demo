...
return (
    <div className="app">
        ...
        <img src={Dots} className="dot-component" height = "90px"/>
            ...
            <br></br>
            <div className="endingleft"><a href="http://localhost:3000/password">FORGET PASSWORD?</a></div>
            <div className="endingleft"><a href="http://localhost:3000/signup">SIGNUP NOW</a></div>
        </div>
    </div>
);
}
